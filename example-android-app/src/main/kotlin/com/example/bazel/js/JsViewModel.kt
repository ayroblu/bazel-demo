...
class JsApp(private val jsViewModel: JsViewModel, private val data: HashMap<String, String>) :
    IApp {
...
class JsAppWrapper(private val jsViewModel: JsViewModel) {
  private val webViewThread = WebViewThread(jsViewModel.getApplication()) { setupWebView(it) }
