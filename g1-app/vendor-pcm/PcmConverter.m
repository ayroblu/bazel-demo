...
// Number of bytes in a single frame, 16Bits takes up two bytes for the next
// sample
...
- (NSMutableData *)decode:(NSData *)lc3data {
    ...
    while (bytesRead < totalBytes) {
        ...
        lc3_decode(lc3_decoder, inBuf, outputByteCount, LC3_PCM_FORMAT_S16,
                   outBuf, 1);

        NSMutableString *hexString =
            [NSMutableString stringWithCapacity:bytesOfFrames * 2];
